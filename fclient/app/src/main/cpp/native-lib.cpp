...
JNIEXPORT jstring
extern "C" jstring Java_ru_iu3_fclient_MainActivity_stringFromJNI (JNIEnv* env, jobject /* this */)
{
...
JNIEXPORT jint
extern "C" jint Java_ru_iu3_fclient_MainActivity_initRng(JNIEnv *env, jclass clazz)
{
    mbedtls_entropy_init( &entropy );
    mbedtls_ctr_drbg_init( &ctr_drbg );
    return mbedtls_ctr_drbg_seed(
            &ctr_drbg , mbedtls_entropy_func, &entropy, (const unsigned char *) personalization,
            strlen( personalization ) );
}
JNIEXPORT jbyteArray
//extern "C" JNICALL
extern "C" jbyteArray Java_ru_iu3_fclient_MainActivity_randomBytes(JNIEnv *env, jclass, jint no)
{
...
JNIEXPORT jbyteArray
extern "C" jbyteArray Java_ru_iu3_fclient_MainActivity_encrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
...
extern "C" JNIEXPORT jbyteArray //JNICALL
extern "C" jbyteArray Java_ru_iu3_fclient_MainActivity_decrypt(JNIEnv *env, jclass, jbyteArray key, jbyteArray data)
{
    jsize ksz = env->GetArrayLength(key);
    jsize dsz = env->GetArrayLength(data);
